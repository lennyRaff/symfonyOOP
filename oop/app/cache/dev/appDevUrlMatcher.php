...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/app/example')) {
            // ajaxcall
            if (0 === strpos($pathinfo, '/app/example/ajax') && preg_match('#^/app/example/ajax(?:/(?P<name>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ajaxcall')), array (  'name' => 'dialogue',  '_controller' => 'AppBundle\\Controller\\AjaxController::indexAction',));
            }
            ...
            // loginpage
            if ($pathinfo === '/app/example/login') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_loginpage;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::loginAction',  '_route' => 'loginpage',);
            }
            not_loginpage:
